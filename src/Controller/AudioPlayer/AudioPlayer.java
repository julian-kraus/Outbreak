...
public class AudioPlayer implements AudioPlayerInterface {
    ...
    private static final String BACKGROUND_MUSIC_FILE_ROCK_PAPER_SCISSORS = "Rock Scissors Paper Finger Play Song.wav";

    private static final String CRASH_SOUND_FILE = "Crash.wav";
    private static final String CRASH_SOUND_FILE_ROCK_PAPER_SCISSORS = "BombSound.wav";
     ...
     */
    public AudioPlayer() {
        this.musicPlayer = new MediaPlayer(loadAudioFile(BACKGROUND_MUSIC_FILE_ROCK_PAPER_SCISSORS));
        this.crashPlayer = new AudioClip(convertNameToUrl(CRASH_SOUND_FILE_ROCK_PAPER_SCISSORS));
    }
