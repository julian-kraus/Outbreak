...
/**
 * Starts the Outbreak Application, loads the GameToolBar and GameBoardUI. This
...
public class OutbreakApplication extends Application {
	...
	/**
	 * Starts the Outbreak Window by setting up a new tool bar, a new user interface
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.setTitle("Outbreak");
	 ...
	 * <p>
	 * Use {@link Outbreak#main(String[])} to run the Java application.
	 */
